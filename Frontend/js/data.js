// ============================================================
// FitLife Gym Management System - Mock Data
// ============================================================

const ADMIN_CREDENTIALS = { username: 'admin', password: 'admin123' };

const WORKOUT_PROGRAMS = [
  'Powerlifting 101', 'HIIT', 'Yoga', 'Zumba', 'Mobility Fix', 'Boxing', 'Swim Endurance'
];
...
let members = [
  {
    ...
    weight: 75, bmi: 24.5, loggedIn: false, loginTime: null,
    sessions: [
  ...
  },
  {
    ...
    weight: 58, bmi: 22.1, loggedIn: false, loginTime: null,
    sessions: []
  },
  {
    id: 'M005', rfid: 'M005', name: 'David Wilson', contact: 'david@example.com',
    plan: 'Silver', status: 'banned', expiry: '2/11/2026',
    weight: 85, bmi: 26.8, loggedIn: false, loginTime: null,
    sessions: []
  },
  {
    id: 'M006', rfid: 'M006', name: 'Lance', contact: 'john@example.com',
    plan: 'Silver', status: 'active', expiry: '3/23/2026',
    weight: 70, bmi: 22.0, loggedIn: false, loginTime: null,
    sessions: []
  }
];
...
let trainers = [
  {
    ...
    sessions: [
      { program: 'Yoga', time: '08:00 AM', client: 'John Smith', month: 2, year: 2026 }
    ],
    totalSessions: 1,
    earningsByMonth: { '2026-2': 60 }
  },
  {
    id: 'T002', rfid: 'T002', name: 'Jessica Lee', specialization: 'HIIT',
    ratePerSession: 70, loggedIn: false, clockInTime: null,
    sessions: [
      { program: 'HIIT', time: '06:00 PM', client: 'Michael Brown', month: 2, year: 2026 }
    ],
    totalSessions: 1,
    earningsByMonth: { '2026-2': 70 }
  },
  {
    id: 'T003', rfid: 'T003', name: 'Ryan Cooper', specialization: 'Powerlifting 101',
    ratePerSession: 65, loggedIn: false, clockInTime: null,
    sessions: [
      { program: 'Powerlifting 101', time: '10:00 AM', client: 'John Smith', month: 2, year: 2026 }
    ],
    totalSessions: 1,
    earningsByMonth: { '2026-2': 65 }
  }
];
...
const retentionData = [
  ...
  { month: 'Apr', rate: 90 }, { month: 'May', rate: 93 }, { month: 'Jun', rate: 94 }
];

// Peak hours data
const peakHoursData = [
  { hour: '6 AM', count: 28 }, { hour: '8 AM', count: 45 }, { hour: '10 AM', count: 31 },
  { hour: '12 PM', count: 33 }, { hour: '2 PM', count: 20 }, { hour: '4 PM', count: 38 },
  { hour: '6 PM', count: 58 }, { hour: '8 PM', count: 46 }
];

// Helper: get trainer earnings for month
function getTrainerEarnings(trainer, filterMonth) {
  ...
  return trainer.earningsByMonth[key] || 0;
}
